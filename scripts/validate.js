...
// ── standalone JS files ─────────────────────────────────────────────────────
for (const file of ["service-worker.js", "i18n.js", "js/ask.js", "js/pdf-import.js", "js/pdf-batch.js", "js/inventory-edit.js", "js/product-edit.js", "js/haccp.js", "js/sales-import.js", "js/api.js", "js/state.js", "js/ui.js", "js/main.js"]) {
  const p = path.join(ROOT, file);
  if (!fs.existsSync(p)) continue;
